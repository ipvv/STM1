...
import saedc.example.com.Alarm.*;
import saedc.example.com.Alarm.NotificationScheduler;
import saedc.example.com.AlarmReceiver;
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    saedc.example.com.Alarm.NotificationScheduler.setReminder(saedc.example.com.Alarm.AlarmActivity.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    saedc.example.com.Alarm.NotificationScheduler.cancelReminder(saedc.example.com.Alarm.AlarmActivity.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
        ...
        TimePickerDialog builder = new TimePickerDialog(this, R.style.DialogTheme,
                new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int hour, int min) {
                        ...
                        tvTime.setText(getFormatedTime(hour, min));
                        NotificationScheduler.setReminder(saedc.example.com.Alarm.AlarmActivity.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
